...
| Type | 템플릿 | 후속 워크플로우 |
|---|---|---|
| `feat` | [`feature.md`](../../../.github/ISSUE_TEMPLATE/feature.md) | `/issue` → `/spec` → `/impl` (전체) |
| `fix` | [`fix.md`](../../../.github/ISSUE_TEMPLATE/fix.md) | `/issue` → `/spec` → `/impl` (전체) |
| `refactor` | [`refactor.md`](../../../.github/ISSUE_TEMPLATE/refactor.md) | `/issue` → `/impl` (spec skip) |
| `docs` / `chore` | [`docs.md`](../../../.github/ISSUE_TEMPLATE/docs.md) | `/issue` → `/impl` (spec skip) |
