...
| 패키지 / 파일 경로 / 레이어 분리 | [`coding-convention.md`](../../../docs/coding-convention.md) §1~3 |
| Entity / Builder / `@Table` / 비즈니스 메서드 패턴 | [`coding-convention.md`](../../../docs/coding-convention.md) §4 |
| `@Transactional` 위치 (클래스 단 readOnly / 메서드 단 override) | [`coding-convention.md`](../../../docs/coding-convention.md) §3 |
| MapStruct / Lombok / Builder 사용 결정 | [`coding-convention.md`](../../../docs/coding-convention.md) §4, §9 |
| 예외 / `BaseErrorCode` / 도메인별 ErrorCode 분리 위치 | [`coding-convention.md`](../../../docs/coding-convention.md) §8 |
| 로그 포맷 문자열 / 레벨 | [`coding-convention.md`](../../../docs/coding-convention.md) §11 |
...
### 마이그레이션
- `V{N}__{설명}.sql` — DB migration policy 따름 (coding-convention §10)
